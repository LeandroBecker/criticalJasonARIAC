...
location(station1,  -3.7,  4.0, 0.0).   
location(station2, -10.8,  3.5, 0.0).   
location(station4, -10.8, -3.5, 0.0).  
location(station3,  -3.7, -3.8, 0.0). 
...
// Critical Perception Plan
+cp(V) : true 
	<-
		.print("Agent detected CRITICAL PERCEPTION ", V);
		trigger_c_reaction.	
